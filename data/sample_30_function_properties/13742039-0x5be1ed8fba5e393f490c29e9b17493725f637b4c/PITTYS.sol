...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    // SEM-ANALYZER #Setter #MappingSetter
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
     ...
     */
    // SEM-ANALYZER #Getter #ArrayGetter #ReturnSize32
...
abstract contract Ownable is Context {
     ...
     */
    // SEM-ANALYZER #Authenticated #Setter #SimpleSetter
...
library SafeMath {
 ...
 contract PITTYS is ERC721Enumerable, Ownable {
    ...
    function setProvenance(string memory provenance) private onlyOwner {
     ...
     // SEM-ANALYZER #Setter #ArrayTypeSetter #Authenticated
