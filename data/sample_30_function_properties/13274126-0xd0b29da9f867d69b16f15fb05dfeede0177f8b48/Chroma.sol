...
contract Chroma is IERC721 {
    ...
    // SEM-ANALYZER #Getter #MappingGetter #ReturnSize20
    ...
    // SEM-ANALYZER #Setter #SimpleSetter #Authenticated
    ...
    // SEM-ANALYZER #Authenticated
    function transmutePlotToNFTs(address _recipient,uint256 _plotId,uint256 _count) external onlyChromaticPlot returns (bool) {
        return _transmute(_recipient, _plotId, _count);
    }

    // SEM-ANALYZER #Authenticated
    function transmutePlotToERC20( address _recipient, uint256 _plotId, uint256 _count) external onlyChromaticPlot returns (bool) {
    ...
    // SEM-ANALYZER #Getter #MappingGetter #ReturnSize1
